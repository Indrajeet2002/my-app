...
function ListSearch(props) {
  ...
  var buttonName = "add-button-" + props.info.original_title;
  ...
  return (
    <div classname= 'w-full flex justify-center'>
      <div className="py-3  flex w-full">
        ...
        <button id={buttonName} className="btn bg-[#1DB954] text-white w-[5%]" onClick={handleClick} disabled={disableButton}>+</button>
      </div>
